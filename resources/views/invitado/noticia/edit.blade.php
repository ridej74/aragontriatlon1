...
<div class="bg-white my-5">
    <div class="box-border border-4 bg-gray-200 m-auto max-w-lg p-5">
        <h1 class="text-2xl text-white bg-gray-700 text-center p-5 border border-line mx-auto max-w-lg">Nueva Noticia</h1>
            <form method="POST" action="{{route('Noticias.update')}}" class="max-w-lg mx-auto my-5" enctype="multipart/form-data" novalidate>
                @csrf
                <div class="mb-5">
                    ...
                    <button type="submit" class="mt-10 p-3 bg-teal-500 w-full hover:bg-teal-600 text-gray-100 font-bold focus:outline focus:shadow-outline uppercase">Actualizar Noticia</button>
                </div>
