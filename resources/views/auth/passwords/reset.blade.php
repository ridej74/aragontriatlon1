                ...
                <form class="py-10 px-5"  method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email"
                            class="p-3 bg-gray-200 rounded form-input w-full  @error('email') border-red-500 @enderror" name="email"
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password"
                            class="p-3 bg-gray-200 rounded form-input w-full @error('password') border-red-500 @enderror" name="password"
