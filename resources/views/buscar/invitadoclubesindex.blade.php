    ...
    <div class="container mx-auto mt-5 text-center">
        ...
        <div class="content mx-20 border-rounded border-gray-100 shadow-lg">
             <table class="min-w-full divide-y divide-gray-200">
                <caption><h1 class="mt-5 text-center text-xl md:text-3xl uppercase mb-5 p-3">{{__('Resultados Búsqueda Clubes')}}</h1> </caption>
                ...
                <tbody class="bg-white divide-y divide-gray-200 text-sm border ">
                    ...
                    <tr>
                        <td width="40" class="px-2 py-1 whitespace-no-wrap">
                            <div class="text-sm text-center text-gray-900">{{$club->id}}</div>
                        </td>
                        <td width="100" class="px-2 whitespace-no-wrap">
                            <div class="text-sm text-center text-gray-900">{{$club->nombre}}</div>
                        </td>      
                        <td width="80" class="px-2 flex place-content-center whitespace-no-wrap">
                            <div class="text-sm text-center text-gray-900"><img src="{{asset('storage/uploads/uploads-club/'.$club->id.'.jpg')}}" width="70" class="bg-green hover:underline"/></div>
                        </td> 

                        <td width="150" class="px-2 whitespace-no-wrap">
                            <div class="text-sm text-center text-gray-900">{{$club->alta}}</div>
                        </td>
