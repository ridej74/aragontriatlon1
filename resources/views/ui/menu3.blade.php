        ...
        <div class="flex flex-col md:flex-row md:justify-between md:items-center">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center py-2 -mx-1 md:mx-0">
                    <a class="block  px-3 py-2 mx-1 rounded text-center text-sm md:text-2xl  bg-indigo-500 font-medium text-white leading-5 hover:bg-blue-600 md:mx-0 md:w-auto" href="{{route('carreras_mapa')}}">
                        Mapa de Carreras
                    </a>
                </div>
                <div class="flex items-center py-2 -mx-1 md:mx-0">
